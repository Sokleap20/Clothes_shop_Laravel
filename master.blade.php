...
>
  <head>
    ...
    <title id="siteTitle">@yield('site-title')</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/listProduct" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/listCategory" class="menu-link">
                    <div data-i18n="Without menu">List Category</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/admin/addCategory" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-bolt-circle"></i>
                <div data-i18n="Layouts">Size</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/listSize" class="menu-link">
                    <div data-i18n="Without menu">List Size</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/admin/addSize" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-bolt-circle"></i>
                <div data-i18n="Layouts">Color</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/listColor" class="menu-link">
                    <div data-i18n="Without menu">List Color</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/admin/addColor" class="menu-link">
                    <div data-i18n="Without menu">Add Color</div>
                  </a>
                </li>
              </ul>
            </li>
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <h4 class="page-main-title m-0 fw-bold" id="mainTitle">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{Auth::user()->profile}}" alt class="w-px-40 h-px-40 rounded-circle" />
                    </div>
                  </a>
